...
public class BetaButton extends ListenerAdapter {

	@SuppressWarnings("unused")
	public void onButtonClick(ButtonClickEvent event) {
		if(event.getComponentId().equalsIgnoreCase("beta-request")) {
			//Get informations
			...
			if(event.getChannelType().equals(ChannelType.TEXT)) {
				...
				event.getTextChannel().sendMessage("We dont have any beta programms yet. Please wait!").queue();
