		...
		String temp = "Invaild";
			...
			if(lan.equalsIgnoreCase("de")) {
				temp = "Regeln des Chats: \r\n"
						...
						+ " -Keine Werbung \r\n"
						+ " -Kein Spam \r\n"
						+ " -[ToS](https://github.com/New-Time-Development/OmeCord/blob/docs/tos/terms.md) \r\n"
						+ " -[privacy](https://github.com/New-Time-Development/OmeCord/blob/docs/privacy/privacy.md) \r\n"
						+ "-------------------------------------------------------------\r\n"
						+ "Links:\r\n"
						+ "Bot Invite:\r\n"
						+ "Server:\r\n"
